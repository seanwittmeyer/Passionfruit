...
<script>
	...
	passionfruitUseZoom = true;
	
	$('.togglezoom').click(function(){
		// $('.lbnz').toggleClass('lbnz').toggleClass('lb');
		// $('.lb').toggleClass('lb').toggleClass('lbnz');
		if (passionfruitUseZoom == true) {
			passionfruitUseZoom = false;
		} else {
			passionfruitUseZoom = true;
		}
		$('.togglezoom').toggleClass('zoomon zoomoff');
		return false;
	});
